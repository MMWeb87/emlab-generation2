 ...
 */
public class MM300AuctionScenarioWithoutTechPref implements Scenario {
...
//		interconnectorNetherlandsGermanyTimeSeries.setStart(4450);
		...
		preferenceMap = new HashMap<>();
		preferenceMap.put(utilityLevelsTechnologyPV, 0.0);
		preferenceMap.put(utilityLevelsTechnologyOnshore, 0.0);
		preferenceMap.put(utilityLevelsTechnologyOffshore, 0.0);
