...
/**
 * Scenario
 * THIS FILE IS AUTOGENERATED IN generate_scenarios.R
 *
 * @author marcmel, ejlchappin
 */
public class MM1d5Scenario1Wacc12 implements Scenario {
...
//		interconnectorNetherlandsGermanyTimeSeries.setStart(4450);
		...
		prefInvestorsSmallDE.setLoanInterestRate(0.12);
		prefInvestorsSmallDE.setEquityInterestRate(0.12);
		...
		prefInvestorsMediumDE.setLoanInterestRate(0.12);
		prefInvestorsMediumDE.setEquityInterestRate(0.12);
		...
		prefInvestorsLargeDE.setLoanInterestRate(0.12);
		prefInvestorsLargeDE.setEquityInterestRate(0.12);
		...
		prefInvestorsVerylargeDE.setLoanInterestRate(0.12);
		prefInvestorsVerylargeDE.setEquityInterestRate(0.12);
		...
		prefInvestorsSmallNL.setEquityInterestRate(0.12);
		...
		prefInvestorsMediumNL.setLoanInterestRate(0.12);
		prefInvestorsMediumNL.setEquityInterestRate(0.12);
		...
		prefInvestorsLargeNL.setLoanInterestRate(0.12);
		prefInvestorsLargeNL.setEquityInterestRate(0.12);
		...
		prefInvestorsVerylargeNL.setLoanInterestRate(0.12);
		prefInvestorsVerylargeNL.setEquityInterestRate(0.12);
