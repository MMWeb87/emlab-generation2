...
# The files must be named "data_*.R" and the * must be the same as the elements in the vector 
config_params[["data_to_load"]] <- c("main")
...
config_params[["analyse_log"]] <- FALSE # only activate if you have a logfile
